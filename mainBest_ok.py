...
jingweidu_tuple_list = [(121.457833,31.210342,"襄阳南路"),# 襄阳南路
...
circleR_distance_list = [(0.0083602, 800),
                         (0.0123602, 1200),
                         (0.0153602, 1500),
                         (0.0183602, 1800),
                         (0.0253602, 2500),
    ...
    def getPointToExecel(self):
        while True:
            try:
                ...
                r_yuan, fanwei_r = circleR_distance_list[self.distance_cnt] # 每个店铺的第一次赋值在这
